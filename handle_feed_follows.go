...
func (apiCfg *apiConfig) createFeedFollowsHandler(w http.ResponseWriter, r *http.Request, user db.User) {
...
func (apiCfg *apiConfig) getFeedFollowsByUserHandler(w http.ResponseWriter, r *http.Request, user db.User) {
...
func (apiCfg *apiConfig) deleteFeedFollowHandler(w http.ResponseWriter, r *http.Request, user db.User) {
